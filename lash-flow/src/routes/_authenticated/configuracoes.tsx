  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <Input id="prazo" type="number" min={1} value={prazo} onChange={(e) => setPrazo(e.target.value)} className="h-11" />
      </div>
      <div className="space-y-2">
        <Label htmlFor="antecedencia">Lembrete com quantos dias de antecedência</Label>
        <Input id="antecedencia" type="number" min={0} value={antecedencia} onChange={(e) => setAntecedencia(e.target.value)} className="h-11" />
      </div>
      <div className="space-y-2">
